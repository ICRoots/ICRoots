...
import { idlFactory } from "./event_bus_backend.did.js";
export { idlFactory } from "./event_bus_backend.did.js";
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_EVENT_BUS_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./event_bus_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the event_bus_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./event_bus_backend.did.js")._SERVICE>}
 */
export const event_bus_backend = createActor(canisterId);
