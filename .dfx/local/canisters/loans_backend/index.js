...
import { idlFactory } from "./loans_backend.did.js";
export { idlFactory } from "./loans_backend.did.js";
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_LOANS_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./loans_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the loans_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./loans_backend.did.js")._SERVICE>}
 */
export const loans_backend = createActor(canisterId);
