...
import { idlFactory } from './trust_ai_backend.did.js';
export { idlFactory } from './trust_ai_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TRUST_AI_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./trust_ai_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the trust_ai_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./trust_ai_backend.did.js")._SERVICE>}
 */
export const trust_ai_backend = createActor(canisterId);
