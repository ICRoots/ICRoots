...
import { idlFactory } from "./repute_backend.did.js";
export { idlFactory } from "./repute_backend.did.js";
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_REPUTE_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./repute_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the repute_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./repute_backend.did.js")._SERVICE>}
 */
export const repute_backend = createActor(canisterId);
